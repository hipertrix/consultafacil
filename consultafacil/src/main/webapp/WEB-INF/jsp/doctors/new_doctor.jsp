...
<form action="${linkTo[DoctorsController].add}" method="post" class="form-horizontal">
				...
				<!--  atributos relativos somente ao médico  -->
				<div class="form-group">
					<label class="sr-only" for="crm"><fmt:message key="user.crm"/></label>
					<input type="text" class="form-control" id="crm" name="user.crm" value="${user.crm}"
					 placeholder="<fmt:message key="user.crm"/>" />
				</div>
